...
class Simulation:
    def __init__(self, num_generations, num_demes, deme_size, num_loci,
        ...
        mutation_rate=Nu/deme_size
            ...
            #allele_freq = np.random.choice([1-initial_allele_freq, initial_allele_freq], num_loci, replace=True, p=[0.5, 0.5])
        ...
        #self.populations = [Population(deme_size, num_loci, mutation_rate, recombination_rate, selection_strength, allele_freq) for _ in range(num_demes)]
    ...
    def run(self):
        ...
        getFrqGen=self.num_generations-10010
